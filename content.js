...
function ensureResponseAnchor(responseNode, fingerprint) {
  ...
  if (!anchor) {
    ...
    anchor.innerHTML = [
      ...
      '<label class="safety-nudges-feedback-consent" hidden><input type="checkbox" class="safety-nudges-feedback-consent-checkbox"> <span>I agree to share this chat\'s details and my optional comment with the Safety Nudges research team for evaluation and product improvement. If I am in a pilot study, this feedback may also include a pseudonymous study ID.</span></label>',
