...
- A popup redesigned around nontechnical use: first-run activation-code vs advanced setup, a simple complementary-vs-model-selection route choice, a prominent play/pause control, and an advanced screen for manual OpenRouter keys and logs.
